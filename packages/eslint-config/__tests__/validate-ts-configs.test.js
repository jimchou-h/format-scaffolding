...
describe('Validate TS configs', () => {
  ...
  it('Validate eslint-config-format-scaffolding/essential/typescript', async () => {
  ...
  it('Validate eslint-config-format-scaffolding/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-format-scaffolding/essential/typescript/vue', async () => {
